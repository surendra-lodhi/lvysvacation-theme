...
add_action( 'widgets_init', 'lvysvacationrentals_followus_widget' );

/**
 * Register the Follow Us Widget
 */
function lvysvacationrentals_followus_widget() {
...
class Followus extends WP_Widget {
    ...
    function __construct(){
        parent::__construct(
                'followus', // Base ID
                __( 'Lvys Vacation Rentals - Follow Us', 'lvysvacationrentals' ), // Name
                array('description' => __( 'Custom follow us widget', 'lvysvacationrentals' )) // Args
        );
    }
    ...
    public function widget($args, $instance) {
        ...
        if( lvysvacationrentals_check_acf_activation() ) {
...
<?php
    ...
    ?>
            <p>
                <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'lvysvacationrentals' ); ?></label> 
