...
<?php 
   $background_image = get_field('lvysvacationrentals_options_background_image','option');
   $title = get_field('lvysvacationrentals_options_title','option');
   $sub_tile = get_field('lvysvacationrentals_options_sub_title','option');
   $content = get_field('lvysvacationrentals_options_content','option');
   $button = get_field('lvysvacationrentals_options_button','option');
?>
<section class="hero-section hero404-section" style="background-image: url(<?php echo $background_image; ?>);">
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="hero-content">
                    ...
                    <?php } ?>
                    <?php if(!empty($sub_tile)) { ?> 
                        <h2><?php echo $sub_tile; ?></h2>
                    <?php } ?>
